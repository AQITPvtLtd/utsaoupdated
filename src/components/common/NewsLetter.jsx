"use client";
import { newsletter } from "../../services/contact-form";
...
const NewsLetter = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm  p-8 shadow-three sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-golden">
      ...
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            value="Subscribe"
            className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm hover:bg-skyblue hover:text-black px-9 py-4 text-base font-medium text-golden shadow-submit duration-300 hover:bg-primary/90 bg-blue-500"
          >
            Subscribe
          </button>
        </form>
